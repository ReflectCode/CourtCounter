...
//                print("RC: oldContentOffset   = " + oldContentOffset)
//                print("RC: sv.contentOffset.y = " + sv.contentOffset.y)
...
//                print("RC: sv.contentSize.height  = " + sv.contentSize.height)
//                print("RC:            offsetY     = " + offsetY)
//                print("RC: sv.contentOffset.y     = " + sv.contentOffset.y)
//                print("RC: sv.content.height - y  = " + (sv.contentSize.height - sv.contentOffset.y))
//                print("RC:     .height - offsetY  = " + (sv.contentSize.height - offsetY))
//                print("RC: sv.bounds.height       = " + sv.bounds.height)
//                print("RC: keyboardHeight         = " + keyboardHeight)
